...
public:
    MI_IMPORT_BASE(TransientMonteCarloIntegrator, m_max_depth, m_rr_depth, m_hide_emitters)
...
MI_IMPLEMENT_CLASS_VARIANT(TransientPathIntegrator, TransientMonteCarloIntegrator)
