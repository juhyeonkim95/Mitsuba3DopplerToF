...
MI_VARIANT TransientIntegrator<Float, Spectrum>::TransientIntegrator(const Properties & props)
    : Base(props) {
...
MI_VARIANT TransientSamplingIntegrator<Float, Spectrum>::TransientSamplingIntegrator(const Properties &props)
    : Base(props) {
...
MI_VARIANT TransientSamplingIntegrator<Float, Spectrum>::~TransientSamplingIntegrator() { }

MI_VARIANT typename TransientSamplingIntegrator<Float, Spectrum>::TensorXf
TransientSamplingIntegrator<Float, Spectrum>::render(Scene *scene,
                                            Sensor *sensor,
                                            uint32_t seed,
                                            uint32_t spp,
                                            bool develop,
...
MI_VARIANT void TransientSamplingIntegrator<Float, Spectrum>::render_block(const Scene *scene,
                                                                   const Sensor *sensor,
                                                                   Sampler *sampler,
                                                                   ImageBlock *block,
                                                                   Float *aovs,
...
MI_VARIANT std::pair<Spectrum, typename TransientSamplingIntegrator<Float, Spectrum>::Mask>
...
MI_VARIANT TransientMonteCarloIntegrator<Float, Spectrum>::TransientMonteCarloIntegrator(const Properties &props)
    : Base(props) {
...
MI_VARIANT TransientMonteCarloIntegrator<Float, Spectrum>::~TransientMonteCarloIntegrator() { }
...
MI_IMPLEMENT_CLASS_VARIANT(TransientIntegrator, Integrator)
MI_IMPLEMENT_CLASS_VARIANT(TransientSamplingIntegrator, TransientIntegrator)
MI_IMPLEMENT_CLASS_VARIANT(TransientMonteCarloIntegrator, TransientSamplingIntegrator)
MI_INSTANTIATE_CLASS(TransientIntegrator)
MI_INSTANTIATE_CLASS(TransientSamplingIntegrator)
MI_INSTANTIATE_CLASS(TransientMonteCarloIntegrator)
